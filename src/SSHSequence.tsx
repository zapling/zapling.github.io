	...
	return (
		<div className="terminal">
			<TerminalCommand
				...
				onTypingDone={() => printAsciiArt(true)}
			>
				<Typist.Delay ms={500} />
				ssh andreaspalm.se
			...
			{asciiArt && (
				<AsciiArt onTypingDone={() => printCatPalmTxtCommand(true)} />
			)}

			{commandCatPalmText && (
				<TerminalCommand
					remoteConnection={true}
					onTypingDone={() => printPalmTxt(true)}
				>
					<Typist.Delay ms={500} />
					cat palm.txt
					<Typist.Delay ms={500} />
		...
		<div className="palmTxt">
			<Typist cursor={""} typingDelay={10}>
				...
				<p>
					...
					<span className="highlight">[Software Developer]</span> at{" "}
					<a
						href="https://zimpler.com"
						target="_blank"
				...
				<p>
					Working with code and learning new things is my passion, and I spend
				...
				<p>
					Navigating the seas of the web is nothing new to me and I travel
					reguarly between servers both via SSH and HTTP(S).
				</p>
				<p>
					I'm always interested in hearing about new opportunities and
					challenges. Don't hesitate to contact me at{" "}
					<span className="highlight">me[a]andreaspalm.se</span>
				</p>
				<p>Here is some helpful hyperlinks ⤦️</p>
				<ul>
					<li>
						<a
							href="https://linkedin.com/in/palm-andreas"
							target="_blank"
							rel="noopener noreferrer"
						>
							[LinkedIn]
